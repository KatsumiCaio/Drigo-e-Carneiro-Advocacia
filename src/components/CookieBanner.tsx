...
export const CookieBanner: React.FC<CookieBannerProps> = ({ onOpenPrivacyModal }) => {
  ...
  return (
    <aside
      ...
      className="fixed bottom-4 left-4 right-4 md:left-6 md:right-auto md:max-w-md z-40 p-5 tobacco-bg gold-border shadow-2xl animate-fadeIn"
    >
      ...
      <div className="flex items-center justify-between gap-2 pt-2 border-t border-[#D4AF37]/15">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="px-3 py-1.5 text-[10px] uppercase tracking-wider font-bold text-[#120D0B] bg-[#D4AF37] hover:bg-[#E5C378] transition-colors cursor-pointer"
          >
            Aceitar Todos
          </button>
        </div>
