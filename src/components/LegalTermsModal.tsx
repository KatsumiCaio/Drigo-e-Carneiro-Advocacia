      ...
      >
        ...
        <div className="flex border-b border-[#D4AF37]/20 bg-[#120D0B] px-6 gap-6">
          <button
            ...
            className={`py-3 text-xs font-bold uppercase tracking-wider transition-all border-b-2 cursor-pointer ${
              activeTab === 'privacy'
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p>
                  ...
                  Não compartilhamos nem comercializamos seus dados com terceiros ou bureaus publicitários sob nenhuma hipótese.
                </p>
              </div>
        ...
        <div className="p-4 border-t border-[#D4AF37]/20 bg-[#120D0B] flex justify-end">
          <button
            onClick={onClose}
            className="px-6 py-2.5 text-xs font-bold uppercase tracking-wider bg-[#D4AF37] hover:bg-[#E5C378] text-[#120D0B] transition-all cursor-pointer"
          >
